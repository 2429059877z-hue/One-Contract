...
本目录另含尚未激活的模块化知识候选版。股权转让是首个深挖试点，已经形成可供律师校验的原则卡、联动模块、结构风险触发器和基础骨架；候选资产不会被正式审查选择器加载。
...
- [references/employment-termination-doctrine.md](./references/employment-termination-doctrine.md)：协商解除劳动合同深度试点
